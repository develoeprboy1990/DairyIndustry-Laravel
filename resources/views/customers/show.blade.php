    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4">
            <div
                class="shadow-sm rounded-3 p-3 justify-content-between position-relative d-flex text-decoration-none bg-white">
                <div class="w-100">
                    <h4 class="text-center">Available Plastic buckets</h4>
                    @if ($plasticBucketStock && count($plasticBucketStock))
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($plasticBucketStock as $bucketId => $stock)
                                    <tr>
                                        <td>{{ $plasticBuckets[$bucketId]['category_name'] ?? '' }}</td>
                                        <td>{{ $stock }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    @else
                        <p>No plastic bucket stock data available.</p>
                    @endif
                </div>
            </div>
        </div>
