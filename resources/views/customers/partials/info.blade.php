<div class="d-flex align-items-center justify-content-center mb-3">
    <div class="mb-0">
        {{-- <a href="{{ route('customers.show', $customer) }}" class="text-body text-decoration-none"> --}}
            ...
            <div class="d-flex">
                <a href="{{ route('customers.print.barcode', $customer) }}" class="btn btn-sm btn-success">Print Barcode</a> 
                <image loading="lazy"
            src="https://barcode.orcascan.com/?type=code128&format=png&data={{ $customer->name }}"
