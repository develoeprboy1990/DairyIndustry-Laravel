            ...
            <div class="col-md-6">
                <table class="table table-bordered table-hover mb-0">
                    <tbody>
                        ...
                        @if ($order->bucketName)
                            <tr>
                                <td width="50%">@lang('Plastic Buckets') - {{ $order->bucketName }}
                                    ({{ $order->bucketStock }} *
                                    {{ currency_format($order->bucketTotalPrice / $order->bucketStock) }})
                                </td>
                                <td width="50%">{{ currency_format($order->bucketTotalPrice) }}</td>
                            </tr>
                        @endif
