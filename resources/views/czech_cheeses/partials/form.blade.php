<form action="{{ isset($czechCheese) ? route('czech_cheeses.update', $czechCheese) : route('czech_cheeses.store') }}"
    ...
    <!-- Type of Cheese -->
    <div class="mb-3">
        <label for="type_of_cheese" class="form-label">@lang('Type of Cheese') (*)</label>
        <input type="text" name="type_of_cheese" class="form-control @error('type_of_cheese') is-invalid @enderror"
            id="type_of_mouneh"
            value="{{ old('type_of_cheese', isset($czechCheese) ? $czechCheese->type_of_cheese : '') }}">
    ...
    <!-- Quantity of Milk -->
    <div class="mb-3">
        <label for="quantity_of_milk" class="form-label">@lang('Quantity of Milk') (kg)</label>
        <input type="text" name="quantity_of_milk"
            class="form-control @error('quantity_of_milk') is-invalid @enderror" id="quantity_of_milk"
            value="{{ old('quantity_of_milk', isset($czechCheese) ? $czechCheese->quantity_of_milk : '') }}">
        @error('quantity_of_milk')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        <label for="quantity_of_swedish_powder" class="form-label">@lang('Quantity of Swedish Powder') (kg)</label>
        <input type="text" name="quantity_of_swedish_powder"
            class="form-control @error('quantity_of_swedish_powder') is-invalid @enderror"
            id="quantity_of_swedish_powder"
            value="{{ old('quantity_of_swedish_powder', isset($czechCheese) ? $czechCheese->quantity_of_swedish_powder : '') }}">
        @error('quantity_of_swedish_powder')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        <label for="quantity_of_tamara_ghee" class="form-label">@lang('Quantity of Tamara Ghee') (kg)</label>
        <input type="text" name="quantity_of_tamara_ghee"
            class="form-control @error('quantity_of_tamara_ghee') is-invalid @enderror" id="quantity_of_tamara_ghee"
            value="{{ old('quantity_of_tamara_ghee', isset($czechCheese) ? $czechCheese->quantity_of_tamara_ghee : '') }}">
        @error('quantity_of_tamara_ghee')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Cheese -->
    <div class="mb-3">
        <label for="quantity_of_starch" class="form-label">@lang('Quantity of Starch') (gauges)</label>
        <input type="text" name="quantity_of_starch"
            class="form-control @error('quantity_of_starch') is-invalid @enderror" id="quantity_of_starch"
            value="{{ old('quantity_of_starch', isset($czechCheese) ? $czechCheese->quantity_of_starch : '') }}">
        @error('quantity_of_starch')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Water -->
    <div class="mb-3">
        <label for="quantity_of_stabilizer" class="form-label">@lang('Quantity of Stabilizer') (kg)</label>
        <input type="text" name="quantity_of_stabilizer"
            class="form-control @error('quantity_of_stabilizer') is-invalid @enderror" id="quantity_of_stabilizer"
            value="{{ old('quantity_of_stabilizer', isset($czechCheese) ? $czechCheese->quantity_of_stabilizer : '') }}">
        @error('quantity_of_stabilizer')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of obj_TC3 -->
    <div class="mb-3">
        <label for="obj_TC3" class="form-label">@lang('TC3')</label>
        <input type="text" name="obj_TC3" class="form-control @error('obj_TC3') is-invalid @enderror" id="obj_TC3"
            value="{{ old('obj_TC3', isset($czechCheese) ? $czechCheese->obj_TC3 : '') }}">
        @error('obj_TC3')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <!-- Quantity of obj_704 -->
    <div class="mb-3">
        <label for="obj_704" class="form-label">@lang('704')</label>
        <input type="text" name="obj_704" class="form-control @error('obj_704') is-invalid @enderror" id="obj_704"
            value="{{ old('obj_704', isset($czechCheese) ? $czechCheese->obj_704 : '') }}">
        @error('obj_704')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <!-- Quantity of salt -->
    <div class="mb-3">
        <label for="quantity_of_salt" class="form-label">@lang('Quantity of Salt') (kg)</label>
        <input type="text" name="quantity_of_salt"
            class="form-control @error('quantity_of_salt') is-invalid @enderror" id="quantity_of_salt"
            value="{{ old('quantity_of_salt', isset($czechCheese) ? $czechCheese->quantity_of_salt : '') }}">
        @error('quantity_of_salt')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Cheese -->
    <div class="mb-3">
        <label for="quantity_of_cheese" class="form-label">@lang('Quantity of Cheese') (kg)</label>
        <input type="text" name="quantity_of_cheese"
            class="form-control @error('quantity_of_cheese') is-invalid @enderror" id="quantity_of_cheese"
            value="{{ old('quantity_of_cheese', isset($czechCheese) ? $czechCheese->quantity_of_cheese : '') }}">
        @error('quantity_of_cheese')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of salt -->
    <div class="mb-3">
        <label for="quantity_of_water" class="form-label">@lang('Quantity of Water') (kg)</label>
        <input type="text" name="quantity_of_water"
            class="form-control @error('quantity_of_water') is-invalid @enderror" id="quantity_of_water"
            value="{{ old('quantity_of_water', isset($czechCheese) ? $czechCheese->quantity_of_water : '') }}">
        @error('quantity_of_water')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        ...
        <input type="text" name="final_quantity"
            class="form-control @error('final_quantity') is-invalid @enderror" id="final_quantity"
            value="{{ old('final_quantity', isset($czechCheese) ? $czechCheese->final_quantity : '') }}"
            onkeyup="{{ isset($czechCheese) ? '' : 'set_stock_from_total()' }}">
                ...
                <x-card>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category"
                            name="category">
                            @isset($product)
                                @foreach ($czechCategory as $category)
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            @lang(isset($czechCheese) ? 'Update Czech Cheese' : 'Save Czech Cheese')
        </button>
    </div>
</form>
