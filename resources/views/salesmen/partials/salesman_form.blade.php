    ...
    <div class="row">
        <div class="col-md-12 d-flex align-items-stretch mb-3">
            <x-card>
                ...
                <x-input label="Return" name="return"
                    value="{{ old('return', isset($salesman) ? $salesman->return : '') }}" />
                <x-input label="Instead" name="instead"
                    value="{{ old('instead', isset($salesman) ? $salesman->instead : '') }}" />
            </x-card>
        </div>
    </div>
