                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif ($payment->employee)
                                        <span class="fw-bold">{{ $payment->employee->name }}</span>
                                    @else
                                        <span>-</span>
                                    @endif
                                </td>
                                ...
                                <td>{{ $payment->mode ?? '-' }} </td>
                                 <td class="align-middle">
                                   {{ optional($payment->expenseCategory)->name ?? '-' }}
                                </td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="filterModalLabel">@lang('Payments Filter')</h1>
