<form action="{{ isset($whiteCheese) ? route('white_cheeses.update', $whiteCheese) : route('white_cheeses.store') }}"
    ...
    <div class="mb-3">
        ...
        <input type="text" name="type_of_cheese" class="form-control @error('type_of_cheese') is-invalid @enderror"
            id="type_of_mouneh"
            value="{{ old('type_of_cheese', isset($whiteCheese) ? $whiteCheese->type_of_cheese : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_milk"
            ...
            value="{{ old('quantity_of_milk', isset($whiteCheese) ? $whiteCheese->quantity_of_milk : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_cylinder_powder"
            ...
            value="{{ old('quantity_of_cylinder_powder', isset($whiteCheese) ? $whiteCheese->quantity_of_cylinder_powder : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_ACC_ghee"
            ...
            value="{{ old('quantity_of_ACC_ghee', isset($whiteCheese) ? $whiteCheese->quantity_of_ACC_ghee : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_starch"
            ...
            value="{{ old('quantity_of_starch', isset($whiteCheese) ? $whiteCheese->quantity_of_starch : '') }}">
    ...
    <!-- Quantity of Water -->
    <div class="mb-3">
        <label for="quantity_of_stabilizer" class="form-label">@lang('Quantity of Stabilizer') (g)</label>
        <input type="text" name="quantity_of_stabilizer"
            ...
            value="{{ old('quantity_of_stabilizer', isset($whiteCheese) ? $whiteCheese->quantity_of_stabilizer : '') }}">
    ...
    <!-- Quantity of quantity_of_protein -->
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_protein"
            ...
            value="{{ old('quantity_of_protein', isset($whiteCheese) ? $whiteCheese->quantity_of_protein : '') }}">
    ...
    <!-- Quantity of quantity_of_calcium -->
    <div class="mb-3">
        <label for="quantity_of_calcium" class="form-label">@lang('Quantity of Calcium')</label>
        <input type="text" name="quantity_of_calcium"
            ...
            value="{{ old('quantity_of_calcium', isset($whiteCheese) ? $whiteCheese->quantity_of_calcium : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_water"
            ...
            value="{{ old('quantity_of_water', isset($whiteCheese) ? $whiteCheese->quantity_of_water : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_salt"
            ...
            value="{{ old('quantity_of_salt', isset($whiteCheese) ? $whiteCheese->quantity_of_salt : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="final_quantity"
            ...
            value="{{ old('final_quantity', isset($whiteCheese) ? $whiteCheese->final_quantity : '') }}"
            onkeyup="{{ isset($whiteCheese) ? '' : 'set_stock_from_total()' }}">
            ...
            <div class="col-md-6 d-flex align-items-stretch mb-3">
                <x-card>
                    ...
                    {{-- <x-select label="Category" name="category" :searchable="true">
                        ...
                        @if ($cheeseCategory->isNotEmpty())
                            @foreach ($cheeseCategory as $category)
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            @lang(isset($whiteCheese) ? 'Update Czech Cheese' : 'Save Czech Cheese')
        </button>
    </div>
</form>
