            ...
            <table style="border: 1px solid; width: 100%;">
                ...
                <tbody>
                    ...
                    @foreach ($doubleCreams as $doubleCream)
                        <tr>
                            <td>{{ $doubleCream->id }}</td>
                            <td>{{ $doubleCream->type_of_cheese }} - cheese_whey
                                {{ $doubleCream->quantity_of_cheese_whey }} - cylinder_powder
                                {{ $doubleCream->quantity_of_cylinder_powder }} - calcium
                                {{ $doubleCream->quantity_of_calcium }}
                            </td>
                            <td></td>
                            <td></td>
                            <td></td>
