<form action="{{ isset($fetaCheese) ? route('feta_cheeses.update', $fetaCheese) : route('feta_cheeses.store') }}"
    ...
    <!-- Type of Cheese -->
    <div class="mb-3">
        <label for="type_of_mouneh" class="form-label">@lang('Type of Milk') (*)</label>
        <input type="text" name="type_of_milk" class="form-control @error('type_of_milk') is-invalid @enderror"
            id="type_of_mouneh" value="{{ old('type_of_milk', isset($fetaCheese) ? $fetaCheese->type_of_milk : '') }}">
        @error('type_of_milk')
    ...
    <!-- Quantity of Milk -->
    <div class="mb-3">
        <label for="quantity_milk" class="form-label">@lang('Quantity of Milk') (kg)</label>
        <input type="text" name="quantity_milk" class="form-control @error('quantity_milk') is-invalid @enderror"
            id="quantity_milk" value="{{ old('quantity_milk', isset($fetaCheese) ? $fetaCheese->quantity_milk : '') }}">
        @error('quantity_milk')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="mb-3">
        <label for="quantity_swedish_powder" class="form-label">@lang('Quantity of Swedish Powder') (kg)</label>
        <input type="text" name="quantity_swedish_powder"
            class="form-control @error('quantity_swedish_powder') is-invalid @enderror" id="quantity_swedish_powder"
            value="{{ old('quantity_swedish_powder', isset($fetaCheese) ? $fetaCheese->quantity_swedish_powder : '') }}">
        @error('quantity_swedish_powder')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        <label for="quantity_ACC_ghee" class="form-label">@lang('Quantity of ACC Ghee') (kg)</label>
        <input type="text" name="quantity_ACC_ghee"
            class="form-control @error('quantity_ACC_ghee') is-invalid @enderror" id="quantity_ACC_ghee"
            value="{{ old('quantity_ACC_ghee', isset($fetaCheese) ? $fetaCheese->quantity_ACC_ghee : '') }}">
        @error('quantity_ACC_ghee')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Water -->
    <div class="mb-3">
        <label for="quantity_protein" class="form-label">@lang('Quantity of Protein') (g)</label>
        <input type="text" name="quantity_protein"
            class="form-control @error('quantity_protein') is-invalid @enderror" id="quantity_protein"
            value="{{ old('quantity_protein', isset($fetaCheese) ? $fetaCheese->quantity_protein : '') }}">
        @error('quantity_protein')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Cheese -->
    <div class="mb-3">
        <label for="quantity_stabilizer" class="form-label">@lang('Quantity of Stabilizer') (g)</label>
        <input type="text" name="quantity_stabilizer"
            class="form-control @error('quantity_stabilizer') is-invalid @enderror" id="quantity_stabilizer"
            value="{{ old('quantity_stabilizer', isset($fetaCheese) ? $fetaCheese->quantity_stabilizer : '') }}">
        @error('quantity_stabilizer')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of obj_TC3 -->
    <div class="mb-3">
        <label for="quantity_GBL" class="form-label">@lang('Quantity of GBL') (g)</label>
        <input type="text" name="quantity_GBL" class="form-control @error('quantity_GBL') is-invalid @enderror"
            id="quantity_GBL" value="{{ old('quantity_GBL', isset($fetaCheese) ? $fetaCheese->quantity_GBL : '') }}">
        @error('quantity_GBL')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <!-- Quantity of obj_TC3 -->
    <div class="mb-3">
        <label for="quantity_cheese" class="form-label">@lang('Quantity of Cheese') (g)</label>
        <input type="text" name="quantity_cheese" class="form-control @error('quantity_cheese') is-invalid @enderror"
            id="quantity_cheese"
            value="{{ old('quantity_cheese', isset($fetaCheese) ? $fetaCheese->quantity_cheese : '') }}">
        @error('quantity_cheese')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of obj_704 -->
    <div class="mb-3">
        <label for="quantity_water" class="form-label">@lang('Quantity of Water') (kg)</label>
        <input type="text" name="quantity_water" class="form-control @error('quantity_water') is-invalid @enderror"
            id="quantity_water"
            value="{{ old('quantity_water', isset($fetaCheese) ? $fetaCheese->quantity_water : '') }}">
        @error('quantity_water')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of obj_704 -->
    <div class="mb-3">
        <label for="quantity_produced" class="form-label">@lang('Final Produced Quantity') (kg)</label>
        <input type="text" name="quantity_produced"
            class="form-control @error('quantity_produced') is-invalid @enderror" id="quantity_produced"
            value="{{ old('quantity_produced', isset($fetaCheese) ? $fetaCheese->quantity_produced : '') }}"
            onkeyup="{{ isset($fetaCheese) ? '' : 'set_stock_from_total()' }}">
        ...
        <div class="row">
            <div class="col-md-6 d-flex align-items-stretch mb-3">
                <x-card>
                    ...
                    {{-- <x-select label="Category" name="category" :searchable="true">
                        ...
                        @if ($fetaCategory->isNotEmpty())
                            @foreach ($fetaCategory as $category)
            ...
            <div class="col-md-6 d-flex align-items-stretch mb-3">
                <x-card>
                    ...
                    <div class="mb-3">
                        <label for="packet_type" class="form-label">@lang('Packet Type')</label>
                        <select class="form-select @error('packet_type') is-invalid @enderror" id="packet_type"
                            name="packet_type">
                            @isset($product)
                                <option value="">Select any one</option>
                                <option value="1kg" @if ($product->packet_type === '1kg') selected @endif>1kg</option>
                                <option value="2kg" @if ($product->packet_type === '2kg') selected @endif>2kg</option>
                                <option value="3kg" @if ($product->packet_type === '3kg') selected @endif>2kg</option>
                            @else
                                <option value="">Select any one</option>
                                <option value="1kg">1kg</option>
                                <option value="2kg">2kg</option>
                                <option value="3kg">2kg</option>
                            @endisset
                        </select>
                        @error('packet_type')
                            <div class="invalid-feedback">
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            @lang(isset($fetaCheese) ? 'Update Country Milk' : 'Save Country Milk')
        </button>
    </div>
</form>
...
@push('script')
    <script>
        ...
        function set_stock_from_total() {
            let final_qt = $("#quantity_produced").val();
