                ...
                <tbody>
                    ...
                    @foreach ($mounehIndustries as $mounehIndustry)
                        <tr>
                            ...
                            <td>{{ $mounehIndustry->type_of_mouneh }} - fruit/vagetables
                                {{ $mounehIndustry->quantity_of_fruit_vegetable }} - sugar/salt
                                {{ $mounehIndustry->quantity_of_sugar_salt }} - Acid
                                {{ $mounehIndustry->quantity_of_acid }} - Glass Used?
                                {{ $mounehIndustry->glass_used ? 'Yes' : 'No' }}</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
