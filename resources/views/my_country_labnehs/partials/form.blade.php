<form
    action="{{ isset($myCountryLabneh) ? route('my_country_labnehs.update', $myCountryLabneh) : route('my_country_labnehs.store') }}"
    method="POST" enctype="multipart/form-data" role="form">
    @csrf
    @isset($myCountryLabneh)
        @method('PUT')
    @endisset
    ...
    <!-- Type of Cheese -->
    <div class="mb-3">
        <label for="type_of_mouneh" class="form-label">@lang('Type of Labneh') (*)</label>
        <input type="text" name="type_of_labneh" class="form-control @error('type_of_labneh') is-invalid @enderror"
            id="type_of_mouneh"
            value="{{ old('type_of_labneh', isset($myCountryLabneh) ? $myCountryLabneh->type_of_labneh : '') }}">
        @error('type_of_labneh')
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_LP_powder"
            ...
            value="{{ old('quantity_of_LP_powder', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_LP_powder : '') }}">
    ...
    <div class="mb-3">
        <label for="quantity_of_ACC_ghee" class="form-label">@lang('Quantity of Swedish ACC Ghee') (kg)</label>
        <input type="text" name="quantity_of_ACC_ghee"
            ...
            value="{{ old('quantity_of_ACC_ghee', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_ACC_ghee : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_stabilizer"
            ...
            value="{{ old('quantity_of_stabilizer', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_stabilizer : '') }}">
    ...
    <!-- Quantity of Water -->
    <div class="mb-3">
        <label for="quantity_of_protein" class="form-label">@lang('Quantity of Protein') (g)</label>
        <input type="text" name="quantity_of_protein"
            class="form-control @error('quantity_of_protein') is-invalid @enderror" id="quantity_of_protein"
            value="{{ old('quantity_of_protein', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_protein : '') }}">
        @error('quantity_of_protein')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Cheese -->
    <div class="mb-3">
        <label for="quantity_of_anti_mold" class="form-label">@lang('Quantity of Anti-mold') (g)</label>
        <input type="text" name="quantity_of_anti_mold"
            ...
            value="{{ old('quantity_of_anti_mold', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_anti_mold : '') }}">
    ...
    <!-- Quantity of obj_TC3 -->
    <div class="mb-3">
        <label for="quantity_of_qarqam" class="form-label">@lang('Quantity of Qarqam') (g)</label>
        <input type="text" name="quantity_of_qarqam"
            class="form-control @error('quantity_of_qarqam') is-invalid @enderror" id="quantity_of_qarqam"
            value="{{ old('quantity_of_qarqam', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_qarqam : '') }}">
        @error('quantity_of_qarqam')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_water"
            ...
            value="{{ old('quantity_of_water', isset($myCountryLabneh) ? $myCountryLabneh->quantity_of_water : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="final_quantity" class="form-control @error('final_quantity') is-invalid @enderror"
            id="final_quantity"
            value="{{ old('final_quantity', isset($myCountryLabneh) ? $myCountryLabneh->final_quantity : '') }}"
            onkeyup="{{ isset($myCountryLabneh) ? '' : 'set_stock_from_total()' }}">
            ...
            <div class="col-md-6 d-flex align-items-stretch mb-3">
                <x-card>
                    ...
                    {{-- <x-select label="Category" name="category" :searchable="true">
                        ...
                        @if ($labnehCategory->isNotEmpty())
                            @foreach ($labnehCategory as $category)
                        ...
                        <select class="form-select @error('main_category') is-invalid @enderror" id="main_category"
                            ...
                            @isset($product)
                                ...
                                <option value="coolingRooms" @if ($product->main_category === 'coolingRooms') selected @endif>Cooling
                                    Rooms
                                </option>    <option value="coolingRoomsBeiruit" @if ($product->main_category === 'coolingRoomsBeiruit') selected @endif>Cooling
                                    Rooms Beiruit
                                </option>
                            @else
                                <option value="">Select any one</option>
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            @lang(isset($myCountryLabneh) ? 'Update Country Milk' : 'Save Country Milk')
        </button>
    </div>
</form>
