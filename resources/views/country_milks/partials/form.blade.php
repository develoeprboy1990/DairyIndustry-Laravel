<form action="{{ isset($countryMilk) ? route('country_milks.update', $countryMilk) : route('country_milks.store') }}"
    ...
    <div class="mb-3">
        ...
        <input type="text" name="type_of_milk" class="form-control @error('type_of_milk') is-invalid @enderror"
            id="type_of_mouneh"
            value="{{ old('type_of_milk', isset($countryMilk) ? $countryMilk->type_of_milk : '') }}">
        @error('type_of_milk')
    ...
    <!-- Quantity of Milk -->
    <div class="mb-3">
        <label for="qty_lp_powder" class="form-label">@lang('Quantity of LP Powder') (kg)</label>
        <input type="text" name="qty_lp_powder" class="form-control @error('qty_lp_powder') is-invalid @enderror"
            id="qty_lp_powder"
            value="{{ old('qty_lp_powder', isset($countryMilk) ? $countryMilk->qty_lp_powder : '') }}">
        @error('qty_lp_powder')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="mb-3">
        <label for="qty_natural_milk" class="form-label">@lang('Quantity of Natural Milk') (kg)</label>
        <input type="text" name="qty_natural_milk"
            class="form-control @error('qty_natural_milk') is-invalid @enderror" id="qty_natural_milk"
            value="{{ old('qty_natural_milk', isset($countryMilk) ? $countryMilk->qty_natural_milk : '') }}">
        @error('qty_natural_milk')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        <label for="qty_ACC_ghee" class="form-label">@lang('Quantity of ACC Ghee') (kg)</label>
        <input type="text" name="qty_ACC_ghee" class="form-control @error('qty_ACC_ghee') is-invalid @enderror"
            id="qty_ACC_ghee" value="{{ old('qty_ACC_ghee', isset($countryMilk) ? $countryMilk->qty_ACC_ghee : '') }}">
        @error('qty_ACC_ghee')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <!-- Quantity of Cheese -->
    <div class="mb-3">
        <label for="qty_stabilizer" class="form-label">@lang('Quantity of Stabilizer') (g)</label>
        <input type="text" name="qty_stabilizer" class="form-control @error('qty_stabilizer') is-invalid @enderror"
            id="qty_stabilizer"
            value="{{ old('qty_stabilizer', isset($countryMilk) ? $countryMilk->qty_stabilizer : '') }}">
        @error('qty_stabilizer')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of Water -->
    <div class="mb-3">
        <label for="qty_protein" class="form-label">@lang('Protein') (g)</label>
        <input type="text" name="qty_protein" class="form-control @error('qty_protein') is-invalid @enderror"
            id="qty_protein" value="{{ old('qty_protein', isset($countryMilk) ? $countryMilk->qty_protein : '') }}">
        @error('qty_protein')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <!-- Quantity of obj_TC3 -->
    <div class="mb-3">
        <label for="qty_anti_mold" class="form-label">@lang('Anti-Mold') (g)</label>
        <input type="text" name="qty_anti_mold" class="form-control @error('qty_anti_mold') is-invalid @enderror"
            id="qty_anti_mold" value="{{ old('obj_TC3', isset($countryMilk) ? $countryMilk->qty_anti_mold : '') }}">
        @error('qty_anti_mold')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <!-- Quantity of obj_704 -->
    <div class="mb-3">
        <label for="qty_water" class="form-label">@lang('Quantity of Water') (kg)</label>
        <input type="text" name="qty_water" class="form-control @error('qty_water') is-invalid @enderror"
            id="qty_water" value="{{ old('qty_water', isset($countryMilk) ? $countryMilk->qty_water : '') }}">
        @error('qty_water')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="final_quantity" class="form-control @error('final_quantity') is-invalid @enderror"
            id="final_quantity"
            value="{{ old('final_quantity', isset($countryMilk) ? $countryMilk->final_quantity : '') }}"
            onkeyup="{{ isset($countryMilk) ? '' : 'set_stock_from_total()' }}">
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            @lang(isset($countryMilk) ? 'Update Country Milk' : 'Save Country Milk')
        </button>
    </div>
</form>
