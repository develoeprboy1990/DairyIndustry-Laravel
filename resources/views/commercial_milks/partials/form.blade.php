<form
    action="{{ isset($commercialMilk) ? route('commercial_milks.update', $commercialMilk) : route('commercial_milks.store') }}"
    method="POST" enctype="multipart/form-data" role="form">
    @csrf
    @isset($commercialMilk)
        @method('PUT')
    @endisset
    ...
    <!-- Type of Cheese -->
    <div class="mb-3">
        <label for="type_of_milk" class="form-label">@lang('Type of Milk') (*)</label>
        <input type="text" name="type_of_milk" class="form-control @error('type_of_milk') is-invalid @enderror"
            id="type_of_mouneh"
            value="{{ old('type_of_milk', isset($commercialMilk) ? $commercialMilk->type_of_milk : '') }}">
        @error('type_of_milk')
    ...
    <!-- Quantity of Milk -->
    <div class="mb-3">
        <label for="quantity_of_LP_powder" class="form-label">@lang('Quantity of LP Powder') (kg)</label>
        <input type="text" name="quantity_of_LP_powder"
            class="form-control @error('quantity_of_LP_powder') is-invalid @enderror" id="quantity_of_LP_powder"
            value="{{ old('quantity_of_LP_powder', isset($commercialMilk) ? $commercialMilk->quantity_of_LP_powder : '') }}">
        @error('quantity_of_LP_powder')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        <label for="quantity_of_ACC_ghee" class="form-label">@lang('Quantity of ACC Ghee ') (kg)</label>
        <input type="text" name="quantity_of_ACC_ghee"
            class="form-control @error('quantity_of_ACC_ghee') is-invalid @enderror" id="quantity_of_ACC_ghee"
            value="{{ old('quantity_of_ACC_ghee', isset($commercialMilk) ? $commercialMilk->quantity_of_ACC_ghee : '') }}">
        @error('quantity_of_ACC_ghee')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of quantity_of_starch -->
    <div class="mb-3">
        <label for="quantity_of_starch" class="form-label">@lang('Quantity of Starch') (kg)</label>
        <input type="text" name="quantity_of_starch"
            ...
            value="{{ old('quantity_of_starch', isset($commercialMilk) ? $commercialMilk->quantity_of_starch : '') }}">
    ...
    <!-- Quantity of quantity_of_stabilizer -->
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_stabilizer"
            ...
            value="{{ old('quantity_of_stabilizer', isset($commercialMilk) ? $commercialMilk->quantity_of_stabilizer : '') }}">
    ...
    <!-- Quantity of quantity_of_sorbate -->
    <div class="mb-3">
        <label for="quantity_of_sorbate" class="form-label">@lang('Quantity of Sorbate') (kg)</label>
        <input type="text" name="quantity_of_sorbate"
            class="form-control @error('quantity_of_sorbate') is-invalid @enderror" id="quantity_of_sorbate"
            value="{{ old('quantity_of_sorbate', isset($commercialMilk) ? $commercialMilk->quantity_of_sorbate : '') }}">
        @error('quantity_of_sorbate')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    </div>
    <!-- Quantity of quantity_of_protin -->
    <div class="mb-3">
        <label for="quantity_of_protin" class="form-label">@lang('Quantity of Protin') (kg)</label>
        <input type="text" name="quantity_of_protin"
            class="form-control @error('quantity_of_protin') is-invalid @enderror" id="quantity_of_protin"
            value="{{ old('quantity_of_protin', isset($commercialMilk) ? $commercialMilk->quantity_of_protin : '') }}">
        @error('quantity_of_protin')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <!-- Quantity of quantity_of_anti_mold -->
    <div class="mb-3">
        <label for="quantity_of_anti_mold" class="form-label">@lang('Quantity of Anti Mold') (kg)</label>
        <input type="text" name="quantity_of_anti_mold"
            class="form-control @error('quantity_of_anti_mold') is-invalid @enderror" id="quantity_of_anti_mold"
            value="{{ old('quantity_of_anti_mold', isset($commercialMilk) ? $commercialMilk->quantity_of_anti_mold : '') }}">
        @error('quantity_of_anti_mold')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
    ...
    <div class="mb-3">
        ...
        <input type="text" name="quantity_of_water"
            ...
            value="{{ old('quantity_of_water', isset($commercialMilk) ? $commercialMilk->quantity_of_water : '') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="final_quantity" class="form-control @error('final_quantity') is-invalid @enderror"
            id="final_quantity"
            value="{{ old('final_quantity', isset($commercialMilk) ? $commercialMilk->final_quantity : '') }}"
            onkeyup="{{ isset($commercialMilk) ? '' : 'set_stock_from_total()' }}">
                ...
                <x-card>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('category') is-invalid @enderror" id="category"
                            name="category">
                            @isset($product)
                                @foreach ($milkCategory as $category)
                        ...
                        <select class="form-select @error('main_category') is-invalid @enderror" id="main_category"
                            ...
                            @else
                                ...
                                <option value="coolingRooms">Cooling Rooms</option>
                                    <option value="coolingRoomsBeiruit">Cooling Rooms Beiruit
                                </option>
                            @endisset
                        </select>
                        @error('main_category')
    ...
    <div class="mb-3">
        <button type="submit" id="submit_btn" class="btn btn-primary" disabled>
            @lang(isset($commercialMilk) ? 'Update Czech Cheese' : 'Save Czech Cheese')
        </button>
    </div>
</form>
