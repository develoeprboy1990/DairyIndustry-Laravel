        ...
        <div class="card-body">
            <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="expense_category_id" class="form-label">@lang('Expense Category')</label>
                        <select name="expense_category_id" id="expense_category_id" class="form-select form-select-lg">
                            <option value="" selected>@lang('Select a Category')</option>
