...
<div class="d-flex align-items-center justify-content-center mb-3">
    <div class="h4 mb-0 flex-grow-1">@lang('Supplier Payments')</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="filterModalLabel">@lang('Supplier Paymetns Filter')</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('supplier-payments.index') }}" method="GET" role="form">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="supplier_id" class="form-label">@lang('Suppliers')</label>
