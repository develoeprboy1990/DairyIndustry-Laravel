...
// routes/api.php
Route::get('/expired-products', [\App\Http\Controllers\API\V1\ProductController::class, 'apiExpiredIndex'])->name('api.expired-products.index');


Route::get('categories', [\App\Http\Controllers\API\V1\CategoryController::class, 'index'])->name('api.categories.index');
Route::get('expense-categories', [\App\Http\Controllers\API\V1\ExpenseCategoryController::class, 'index'])->name('api.expense-categories.index');
...
Route::get('/getBuckets', [\App\Http\Controllers\API\V1\SalesmanController::class, 'getBuckets']);
