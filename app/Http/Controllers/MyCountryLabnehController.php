...
use App\Models\MyCountryLabneh;
...
use App\Http\Requests\MyCountryLabnehRequest;
use Illuminate\View\View;

class MyCountryLabnehController extends Controller
{
    /**
    ...
    {
        $myCountryLabnehs = MyCountryLabneh::search($request->search_query)->orderBy('created_at', 'desc')->paginate(20);
        return view('my_country_labnehs.index', [
            'myCountryLabnehs' => $myCountryLabnehs
        ]);
    }
    ...
    {
        $myCountryLabnehs = MyCountryLabneh::search($request->search_query)->orderBy('created_at', 'desc')->get();
        return view('my_country_labnehs.print', [
            'myCountryLabnehs' => $myCountryLabnehs
        ]);
    }
    ...
    public function create(): View
    {
        ...
        $labnehCategory = Category::where('is_active', 1)->get();
        ...
        return view("my_country_labnehs.create", [
            'labnehCategory' => $labnehCategory, // Pass the 'mouneh' category
     ...
     *
     * @param  \App\Http\Requests\MyCountryLabnehRequest  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    public function store(MyCountryLabnehRequest $request): RedirectResponse
    {

        $myCountryLabneh = new MyCountryLabneh();
        $myCountryLabneh->type_of_labneh = $request->type_of_labneh;
        $myCountryLabneh->quantity_of_LP_powder = $request->quantity_of_LP_powder;
        $myCountryLabneh->quantity_of_ACC_ghee = $request->quantity_of_ACC_ghee;
        $myCountryLabneh->quantity_of_stabilizer = $request->quantity_of_stabilizer;
        $myCountryLabneh->quantity_of_protein = $request->quantity_of_protein;
        $myCountryLabneh->quantity_of_anti_mold = $request->quantity_of_anti_mold;
        $myCountryLabneh->quantity_of_qarqam = $request->quantity_of_qarqam;
        $myCountryLabneh->quantity_of_water = $request->quantity_of_water;
        $myCountryLabneh->final_quantity = $request->final_quantity;
        ...
        if ($request->next_phase) {
            ...
            // Attach the created product ID to the myCountryLabneh
            $myCountryLabneh->product_id = $product->id;
            ...
            $myCountryLabneh->product_id = null;
        }
        
        $myCountryLabneh->save();
        ...
        $ingredient->quantity_of_qarqam =  $ingredient->quantity_of_qarqam + ($request->quantity_of_qarqam ?? 0);
     ...
     *
     * @param  \App\Models\MyCountryLabneh  $myCountryLabneh
     * @return \Illuminate\View\View
     */
    public function edit(MyCountryLabneh $myCountryLabneh): View
    {
         $labnehCategory = Category::where('is_active', 1)->get();
        
        // Fetch the associated product, if it exists
        $product = $myCountryLabneh->product_id
        ? Product::find($myCountryLabneh->product_id)
        : null;
        ...
        return view("my_country_labnehs.edit", [
            'myCountryLabneh' => $myCountryLabneh,
            'labnehCategory' => $labnehCategory,
            'product'=> $product,
            'isNextPhaseChecked' => $isNextPhaseChecked,
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function update(MyCountryLabnehRequest $request, MyCountryLabneh $myCountryLabneh): RedirectResponse
    {
        $old_myCountryLabneh = MyCountryLabneh::findOrFail($myCountryLabneh->id);

        // ====save the Ingredients
        $ingredient = Ingredient::first();
        $ingredient->quantity_of_LP_powder = ($ingredient->quantity_of_LP_powder - $old_myCountryLabneh->quantity_of_LP_powder) + ($request->quantity_of_LP_powder ?? 0);
        $ingredient->quantity_of_ACC_ghee = ($ingredient->quantity_of_milk - $old_myCountryLabneh->quantity_of_ACC_ghee) + ($request->quantity_of_ACC_ghee ?? 0);
        $ingredient->quantity_of_stabilizer = ($ingredient->quantity_of_ACC_ghee - $old_myCountryLabneh->quantity_of_stabilizer) + ($request->quantity_of_stabilizer ?? 0);
        $ingredient->quantity_of_protin = ($ingredient->quantity_of_stabilizer - $old_myCountryLabneh->quantity_of_protein) + ($request->quantity_of_protein ?? 0);
        $ingredient->quantity_of_anti_mold = ($ingredient->quantity_of_protin - $old_myCountryLabneh->quantity_of_anti_mold) + ($request->quantity_of_anti_mold ?? 0);
        $ingredient->quantity_of_qarqam = ($ingredient->quantity_of_anti_mold - $old_myCountryLabneh->quantity_of_qarqam) + ($request->quantity_of_qarqam ?? 0);
        $ingredient->quantity_of_water =  ($ingredient->quantity_of_water - $old_myCountryLabneh->quantity_of_water) + ($request->quantity_of_water ?? 0);
        // Save the updated record.
        $ingredient->save();
        // ============================
        ...
        if ($myCountryLabneh->product_id) {
            ...
            $product = Product::find($myCountryLabneh->product_id);
            ...
            $myCountryLabneh->product_id = $product->id; // Store the new product ID
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
   public function destroy(MyCountryLabneh $myCountryLabneh): RedirectResponse
   {
       // Delete the associated product if it exists
       if ($myCountryLabneh->product) {
           $myCountryLabneh->product->delete(); // Delete the related Product
       }
   
       // Delete the MounehIndustry record
       $myCountryLabneh->delete();
